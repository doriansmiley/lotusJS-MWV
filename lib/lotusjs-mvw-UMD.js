...
var TestContext = /** @class */ (function (_super) {
    ...
    TestContext.prototype.mapObjects = function () {
        ...
        this.injector.mapSingletonInstance(Context_1.Context, this);
    };
    TestContext.getInstance = function (model, params) {
        if (TestContext.INSTANCE == null) {
