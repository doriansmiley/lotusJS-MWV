...
describe('ImageGalleryItemCollectionViewTest', function() {
  ...
  describe('LotusMVW.ImageGalleryCollectionView', function(){

    it('should test default ImageGalleryCollectionView values', function() {
        var component = new LotusMVW.ImageGalleryCollectionView();
        var element = document.createElement('div');
        element.setAttribute('data-attribute-item-view', 'LotusMVW.ImageGalleryView');
        ...
        expect( component.itemView === 'LotusMVW.ImageGalleryView' ).toBe( true );
        expect( component.createChildView() instanceof LotusMVW.ImageGalleryView ).toBe( true );
