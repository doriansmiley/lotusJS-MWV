...
describe('SkinPartListTest', function () {
    ...
    it('check SkinPartList function and values', function () {
        var skinPartList = new LotusMVW.SkinPartList();
        var component1 = new LotusMVW.AbstractComponent();
        var component2 = new LotusMVW.AbstractComponent();
        var component3 = new LotusMVW.AbstractComponent();
        var component4 = new LotusMVW.AbstractComponent();
        var skinPart1 = new LotusMVW.SkinPart('testSkinPart1', component1, 'testProperty');
        var skinPart2 = new LotusMVW.SkinPart('testSkinPart2', component2, 'testProperty');
        var skinPart3 = new LotusMVW.SkinPart('testSkinPart3', component3, 'testProperty');
        skinPartList.addAll([skinPart1, skinPart2, skinPart3]);
        expect(skinPartList.length).toBe(3);
        var skinPart4 = new LotusMVW.SkinPart('testSkinPart4', component4, 'testProperty');
