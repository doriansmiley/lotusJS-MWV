...
describe('AbstractRecordSetCollectionViewTest', function() {
  ...
  describe('LotusMVW.AbstractRecodSetCollectionView', function(){

    it('should test default AbstractRecodSetCollectionView values', function() {
        var component = new LotusMVW.AbstractRecordSetCollectionView();
        var element = document.createElement('div');
        element.setAttribute('data-attribute-item-view', 'LotusMVW.AbstractItemView');
        ...
        expect( component.itemView === 'LotusMVW.AbstractItemView' ).toBe( true );
        expect( component.createChildView() instanceof LotusMVW.AbstractItemView ).toBe( true );
