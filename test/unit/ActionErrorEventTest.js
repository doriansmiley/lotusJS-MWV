...
describe('ActionErrorEventTest ', function () {
    ...
    it('check ActionErrorEvent function and values', function () {
        var actionErrorEvent = new LotusMVW.ActionErrorEvent(LotusMVW.ActionErrorEvent.ERROR, {message:'test error message', subject:'test subject', details:'test details', code:'test code'});
        expect( actionErrorEvent.type ).toBe(LotusMVW.ActionErrorEvent.ERROR);
