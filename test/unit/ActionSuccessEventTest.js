...
describe('ActionSuccessEventTest ', function () {
    ...
    it('check ActionSuccessEvent function and values', function () {
        var actionErrorEvent = new LotusMVW.ActionSuccessEvent(LotusMVW.ActionSuccessEvent.SUCCESS, {message:'test success message', subject:'test subject', details:'test details', code:'test code'});
        expect( actionErrorEvent.type ).toBe(LotusMVW.ActionSuccessEvent.SUCCESS);
